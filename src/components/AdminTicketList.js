...
import { addNewTicket, deleteTicketById, getAllTicket, updateTicketById } from '../utils/functions';
...
export const AdminTicketList = () => {
	...
	async function onSubmitHandler(e) {
		e.preventDefault();
		if (detail === '') {
			const data = await addNewTicket(asal, tujuan, tanggal, waktuBerangkat, waktuTiba, harga);
			...
			const data = await updateTicketById(id, asal, tujuan, tanggal, waktuBerangkat, waktuTiba, harga);
		...
		return (
			<Container>
              ...
              Save Changes
				...
				<Table striped bordered hover style={{ borderWidth: 1, borderColor: 'black' }}>
					<thead>
						<tr>
							<th>No</th>
							<th>ID</th>
								...
								<tr>
									...
									<td>
										<ButtonGroup aria-label="Basic example">
											...
											<Button variant="danger" onClick={() => onDeleteHandler(item._id)}>
												Delete
											</Button>
										</ButtonGroup>
									</td>
